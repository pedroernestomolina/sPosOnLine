...
namespace PosOnLine.Data.Infra
{
    ...
    {
        OOB.Resultado.Lista<OOB.Producto.Lista.Ficha> 
            Producto_GetLista(OOB.Producto.Lista.Filtro filtro);
        OOB.Resultado.FichaEntidad<OOB.Producto.Entidad.Ficha> 
        ...
        OOB.Resultado.FichaEntidad<OOB.Producto.Existencia.Entidad.Ficha> 
            Producto_Existencia_GetByPrdDeposito(OOB.Producto.Existencia.Buscar.Ficha ficha);
        OOB.Resultado.FichaEntidad<OOB.Producto.Costo.Ficha> 
