    ...
    public partial class DataPrv : IData
    {
            ...
            Documento_Agregar_Factura(OOB.Documento.Agregar.Factura.Ficha ficha)
        {
            ...
            var fichaDTO = new DtoLibPos.Documento.Agregar.Factura.Ficha()
            {
                ...
                //
                aplicaIGTF = ficha.aplicarIGTF ? "1" : "",
                tasaIGTF = ficha.tasaIGTF,
                baseAplicaIGTFMonAct = ficha.baseAplicaIGTFMonAct,
            ...
            if (ficha.ResumenGeneral != null) 
            {
                ...
                resumenGeneral = new DtoLibPos.Documento.Agregar.Factura.FichaPosResumenGeneral()
                {
            ...
            //
            var lst_DetalleFormaPago = new List<DtoLibPos.Documento.Agregar.Factura.FichaPosResumenDetalleFormaPago>();
            if (ficha.DetalleFormaPago != null) 
            {
                foreach (var it in ficha.DetalleFormaPago) 
                {
                    var detalleFormaPago = new DtoLibPos.Documento.Agregar.Factura.FichaPosResumenDetalleFormaPago()
                    {
