...
namespace PosOnLine.Helpers.Imprimir.CuadreCaja._80
{
    public class Imp: baseImprimirReporteCuadreCajaTicket
    {
        public Imp()
            :base()
        {
        }
        public override void ImprimirDoc()
        {
            var _lista = new List<string>();
            //
            _lista.Clear();
