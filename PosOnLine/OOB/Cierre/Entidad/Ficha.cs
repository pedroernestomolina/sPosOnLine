...
namespace PosOnLine.OOB.Cierre.Entidad
{
    ...
    public class Ficha
    {
        ...
        public decimal SegunUsuario 
        { 
            get 
            {
                var rt = 0m;
                rt += mefectivo + mcheque + mtarjeta + motros;
                return rt;
            }
        }
        public decimal SegunSistema
        {
            get
            {
                var rt = 0m;
                rt += efectivo + cheque + debito + otros;
                return rt;
            }
        }
