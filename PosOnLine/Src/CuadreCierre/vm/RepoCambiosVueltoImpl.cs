...
namespace PosOnLine.Src.CuadreCierre.vm
{
    public class RepoCambiosVueltoImpl: IRepoCambiosVuelto
    {
        ...
        //
        public void setDataCargar(List<Domain.Models.RepoCambiosVuelto> list)
        {
            _lista = list;
        }
        public void Generar()
        {
            var pt = AppDomain.CurrentDomain.BaseDirectory + @"\Src\CuadreCierre\repo\VueltosEntregado.rdlc";
            var ds = new repo.DS();
            //
