...
namespace PosOnLine.Src.Pos
{
    ...
    public partial class PosPedidoFrm : Form
    {
        ...
        //
        private void BT_TARJETA_PEDIDO_GUARDAR_Click(object sender, EventArgs e)
        {
            GuardarPedido();
        }
        private void BT_TARJETA_PEDIDO_ABRIR_Click(object sender, EventArgs e)
        {
            AbrirPedido();
        }
    }
