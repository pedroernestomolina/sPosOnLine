...
namespace PosOnLine.Src.PosImprimirTicket.Domain.Models
{
    public class Data
    {
        public enum TipoDocumento { SinDefinir = -1, Factura = 1, NotaDebito, NotaCredito, NotaEntrega };
        ...
        public TipoDocumento tipoDocumento
        {
            get 
            {
                switch (codigoDoc.Trim().ToUpper())
                {
                    ...
                    case "02":
                        return TipoDocumento.NotaDebito;
                    case "03":
                        return TipoDocumento.NotaCredito;
                    case "04":
                        return TipoDocumento.NotaEntrega;
                    default:
                        return TipoDocumento.SinDefinir;
                }
            }
        }
    }
