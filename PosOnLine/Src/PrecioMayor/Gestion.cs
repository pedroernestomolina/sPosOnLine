...
namespace PosOnLine.Src.PrecioMayor
{
    public class Gestion : IModo
    {
                ...
                if (_ficha.PreciosMayorHabilitado)
                {
                    ...
                    switch (_tarifa)
                    {
                        case "1":
                            ...
                            if (!_ficha.IsDivisa) 
                            {
                                _pn = calculaNeto(_ficha.pdf_1, _ficha.TasaImpuesto) * _factorCambio; 
                            }
                            //var p1 = new precio("1", _ficha.empaque_1, _ficha.contenido_1, _ficha.pneto_1, _ficha.decimales_1);
                            var p1 = new precio("1", _ficha.empaque_1, _ficha.contenido_1, _pn , _ficha.decimales_1);
                            ...
                            _pn = _ficha.pnetoMay_1;
                            if (!_ficha.IsDivisa) 
                            {
                                _pn = calculaNeto(_ficha.pdfMay_1, _ficha.TasaImpuesto) * _factorCambio; 
                            }
                            //var pM1 = new precio("6", _ficha.empaqueMay_1, _ficha.contenidoMay_1, _ficha.pnetoMay_1, _ficha.decimalesMay_1);
                            var pM1 = new precio("6", _ficha.empaqueMay_1, _ficha.contenidoMay_1, _pn, _ficha.decimalesMay_1);
                            ...
                            _pn = _ficha.pnetoDsp_1;
                            if (!_ficha.IsDivisa) 
                            {
                                _pn = calculaNeto(_ficha.pdfDsp_1, _ficha.TasaImpuesto) * _factorCambio; 
                            }
                            //var pD1 = new precio("10", _ficha.empaqueDsp_1, _ficha.contenidoDsp_1, _ficha.pnetoDsp_1, _ficha.decimalesDsp_1);
                            var pD1 = new precio("10", _ficha.empaqueDsp_1, _ficha.contenidoDsp_1, _pn , _ficha.decimalesDsp_1);
                        ...
                        case "2":
                            ...
                            if (!_ficha.IsDivisa) 
                            {
                                _pn = calculaNeto(_ficha.pdf_2, _ficha.TasaImpuesto) * _factorCambio; 
                            }
                            //var p2 = new precio("2", _ficha.empaque_2, _ficha.contenido_2, _ficha.pneto_2, _ficha.decimales_2);
                            var p2 = new precio("2", _ficha.empaque_2, _ficha.contenido_2, _pn , _ficha.decimales_2);
                            ...
                            _pn = _ficha.pnetoMay_2;
                            if (!_ficha.IsDivisa) 
                            {
                                _pn = calculaNeto(_ficha.pdfMay_2, _ficha.TasaImpuesto) * _factorCambio; 
                            }
                            //var pM2 = new precio("7", _ficha.empaqueMay_2, _ficha.contenidoMay_2, _ficha.pnetoMay_2, _ficha.decimalesMay_2);
                            var pM2 = new precio("7", _ficha.empaqueMay_2, _ficha.contenidoMay_2, _pn , _ficha.decimalesMay_2);
                            ...
                            _pn = _ficha.pnetoDsp_2;
                            if (!_ficha.IsDivisa) 
                            {
                                _pn = calculaNeto(_ficha.pdfDsp_2, _ficha.TasaImpuesto) * _factorCambio; 
                            }
                            //var pD2 = new precio("B", _ficha.empaqueDsp_2, _ficha.contenidoDsp_2, _ficha.pnetoDsp_2, _ficha.decimalesDsp_2);
                            var pD2 = new precio("B", _ficha.empaqueDsp_2, _ficha.contenidoDsp_2, _pn , _ficha.decimalesDsp_2);
                        ...
                        case "3":
                            ...
                            if (!_ficha.IsDivisa) 
                            {
                                _pn = calculaNeto(_ficha.pdf_3, _ficha.TasaImpuesto) * _factorCambio; 
                            }
                            //var p3 = new precio("3", _ficha.empaque_3, _ficha.contenido_3, _ficha.pneto_3, _ficha.decimales_3);
                            var p3 = new precio("3", _ficha.empaque_3, _ficha.contenido_3, _pn , _ficha.decimales_3);
                            ...
                            _pn = _ficha.pnetoMay_3;
                            if (!_ficha.IsDivisa) 
                            {
                                _pn = calculaNeto(_ficha.pdfMay_3, _ficha.TasaImpuesto) * _factorCambio; 
                            }
                            //var pM3 = new precio("8", _ficha.empaqueMay_3, _ficha.contenidoMay_3, _ficha.pnetoMay_3, _ficha.decimalesMay_3);
                            var pM3 = new precio("8", _ficha.empaqueMay_3, _ficha.contenidoMay_3, _pn , _ficha.decimalesMay_3);
                            ...
                            _pn = _ficha.pnetoDsp_3;
                            if (!_ficha.IsDivisa) 
                            {
                                _pn = calculaNeto(_ficha.pdfDsp_3, _ficha.TasaImpuesto) * _factorCambio; 
                            }
                            //var pD3 = new precio("C", _ficha.empaqueDsp_3, _ficha.contenidoDsp_3, _ficha.pnetoDsp_3, _ficha.decimalesDsp_3);
                            var pD3 = new precio("C", _ficha.empaqueDsp_3, _ficha.contenidoDsp_3, _pn , _ficha.decimalesDsp_3);
                        ...
                        case "4":
                            ...
                            if (!_ficha.IsDivisa) 
                            {
                                _pn = calculaNeto(_ficha.pdf_4, _ficha.TasaImpuesto) * _factorCambio; 
                            }
                            //var p4 = new precio("4", _ficha.empaque_4, _ficha.contenido_4, _ficha.pneto_4, _ficha.decimales_4);
                            var p4 = new precio("4", _ficha.empaque_4, _ficha.contenido_4, _pn , _ficha.decimales_4);
                            ...
                            _pn = _ficha.pnetoMay_4;
                            if (!_ficha.IsDivisa) 
                            {
                                _pn = calculaNeto(_ficha.pdfMay_4, _ficha.TasaImpuesto) * _factorCambio; 
                            }
                            //var pM4 = new precio("9", _ficha.empaqueMay_4, _ficha.contenidoMay_4, _ficha.pnetoMay_4, _ficha.decimalesMay_4);
                            var pM4 = new precio("9", _ficha.empaqueMay_4, _ficha.contenidoMay_4, _pn , _ficha.decimalesMay_4);
                            ...
                            _pn = _ficha.pnetoDsp_4;
                            if (!_ficha.IsDivisa) 
                            {
                                _pn = calculaNeto(_ficha.pdfDsp_4, _ficha.TasaImpuesto) * _factorCambio; 
                            }
                            //var pD4 = new precio("D", _ficha.empaqueDsp_4, _ficha.contenidoDsp_4, _ficha.pnetoDsp_4, _ficha.decimalesDsp_4);
                            var pD4 = new precio("D", _ficha.empaqueDsp_4, _ficha.contenidoDsp_4, _pn , _ficha.decimalesDsp_4);
                        ...
                        case "5":
                            ...
                            if (!_ficha.IsDivisa) 
                            {
                                _pn = calculaNeto(_ficha.pdf_5, _ficha.TasaImpuesto) * _factorCambio; 
                            }
                            //var p5 = new precio("5", _ficha.empaque_5, _ficha.contenido_5, _ficha.pneto_5, _ficha.decimales_5);
                            var p5 = new precio("5", _ficha.empaque_5, _ficha.contenido_5, _pn, _ficha.decimales_5);
                        ...
                        default:
                            ...
                            var p11 = new precio("1", _ficha.empaque_1, _ficha.contenido_1, _pn , _ficha.decimales_1);
        ...
        private decimal calculaNeto(decimal monto, decimal tasaIva)
        {
            var rt = monto;
            if (tasaIva > 0m) 
            {
                rt = monto / (1m + (tasaIva / 100m));
            }
            return rt;
        }
        ...
        private bool CargarData()
        {
            ...
            var r01 = _obtenerFichaProductoUsecase.Execute(_autoPrd);
